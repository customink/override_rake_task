# Insert line: [require "#{Rails.root}/vendor/plugins/override_rake_task/lib/override_rake_task.rb"]
...
output= ""
inserted = false
line_to_insert = %q{require "#{Rails.root}/vendor/plugins/override_rake_task/lib/override_rake_task.rb"}
